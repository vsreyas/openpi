#!/bin/bash
#SBATCH --job-name=pi05_yam_arrange_all
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
#SBATCH --output=/data/user_data/sreyasv/yam_logs/logs/pi05_yam_arrange_all_%j.out
#SBATCH --error=/data/user_data/sreyasv/yam_logs/logs/pi05_yam_arrange_all_%j.err

# =============================================================================
# YAM: Pi-0.5 LoRA fine-tune on arrange-corn-knife, ALL trajectories.
# Filter resolves to 10 episodes / 9833 frames. Full-task BC corpus.
#
...
#
# Usage:
#   sbatch slurm_yam_arrange_all.sh
#   RUN_TAG=v2 sbatch slurm_yam_arrange_all.sh
# =============================================================================
...
echo "Starting pi05_yam_arrange_all_lora run_tag=${RUN_TAG} batch_size=${BATCH_SIZE}"

python scripts/train.py pi05_yam_arrange_all_lora \
    --exp-name=pi05_yam_arrange_all_${RUN_TAG} \
