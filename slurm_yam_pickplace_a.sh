#!/bin/bash
#SBATCH --job-name=pi05_yam_pickplace_a
#SBATCH --nodes=1
#SBATCH --gres=gpu:2
...
#SBATCH --output=/data/user_data/sreyasv/yam_logs/logs/pi05_yam_pickplace_a_%j.out
#SBATCH --error=/data/user_data/sreyasv/yam_logs/logs/pi05_yam_pickplace_a_%j.err

# =============================================================================
# YAM: Pi-0.5 LoRA fine-tune on pick-place, single traj (orig_traj_id_6 == 14512).
# Filter resolves to 1 episode / 1097 frames. Single-traj overfit baseline.
#
...
#
# Usage:
#   sbatch slurm_yam_pickplace_a.sh
#   RUN_TAG=v2 sbatch slurm_yam_pickplace_a.sh
# =============================================================================
...
echo "Starting pi05_yam_pickplace_a_lora run_tag=${RUN_TAG} batch_size=${BATCH_SIZE}"

python scripts/train.py pi05_yam_pickplace_a_lora \
    --exp-name=pi05_yam_pickplace_a_${RUN_TAG} \
